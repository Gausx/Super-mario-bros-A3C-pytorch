...
from src.process_tiles_success_rule import local_train, local_test
...
def get_args():
    ...
    parser.add_argument("--log_path", type=str, default="tensorboard/a3c_super_mario_bros_tiles_rule")
